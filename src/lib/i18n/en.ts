const en = {
  ...
  settings: {
    ...
    backendDesc: 'Choose the image generation backend',
    backendNai: 'NovelAI',
    ...
    comfyuiTestConnection: 'Test Connection',
    comfyuiTesting: 'Testing...',
    comfyuiConnected: 'Connected',
    comfyuiConnectionFailed: 'Connection failed',
    comfyuiWorkflows: 'Workflows',
    comfyuiWorkflowName: 'Workflow Name',
    comfyuiUploadWorkflow: 'Upload Workflow JSON',
    comfyuiNoWorkflows: 'No workflows uploaded yet',
    comfyuiWorkflowCreated: 'Workflow created',
    comfyuiWorkflowDeleted: 'Workflow deleted',
    comfyuiWorkflowDefault: 'Default',
    comfyuiWorkflowSetDefault: 'Set as Default',
    comfyuiWorkflowInvalid: 'Invalid workflow',
  },
  gallery: {
    title: 'Gallery',
    imageCount: '{{count}} images',
  ...
  reference: {
    ...
    strength: 'Strength',
    informationExtracted: 'Info Extracted',
    fidelity: 'Fidelity',
    mode: 'Mode',
    modeCharacter: 'Character',
    modeStyle: 'Style',
    modeCharacterStyle: 'Character & Style',
    v45Only: 'V4.5 models only',
    enabled: 'Enabled',
    disabled: 'Disabled',
    encodingPending: 'Will encode on next generation',
    encodingMismatch: 'Re-encoding needed (model changed)',
    deleteConfirm: 'Delete this reference image?',
    deleteDesc: 'This will permanently remove the reference image.',
    uploadFailed: 'Failed to upload reference image',
    deleteFailed: 'Failed to delete reference image',
    ...
    comfyuiNote:
      'Reference images are managed in your ComfyUI workflow (IPAdapter, ControlNet, etc.)',
  },
  comfyuiParams: {
    workflow: 'Workflow',
    workflowHelp: 'ComfyUI workflow template to use for generation',
    model: 'Checkpoint',
    modelHelp: 'Stable Diffusion checkpoint model',
    noWorkflows: 'Upload a workflow in Settings first',
    loadingModels: 'Loading models...',
    noModels: 'Connect to ComfyUI server first',
  },
} as const
