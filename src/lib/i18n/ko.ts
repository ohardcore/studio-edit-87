...
const ko: DeepStringify<typeof en> = {
  ...
  settings: {
    ...
    uiScaleReset: '초기화',
    backend: '생성 백엔드',
    backendDesc: '이미지 생성 백엔드를 선택합니다',
    backendNai: 'NovelAI',
    backendComfyui: 'ComfyUI',
    comfyuiSettings: 'ComfyUI 설정',
    comfyuiServerUrl: '서버 URL',
    comfyuiServerUrlPlaceholder: 'http://localhost:8188',
    comfyuiTestConnection: '연결 테스트',
    comfyuiTesting: '테스트 중...',
    comfyuiConnected: '연결됨',
    comfyuiConnectionFailed: '연결 실패',
    comfyuiWorkflows: '워크플로우',
    comfyuiWorkflowName: '워크플로우 이름',
    comfyuiUploadWorkflow: '워크플로우 JSON 업로드',
    comfyuiNoWorkflows: '업로드된 워크플로우가 없습니다',
    comfyuiWorkflowCreated: '워크플로우가 생성되었습니다',
    comfyuiWorkflowDeleted: '워크플로우가 삭제되었습니다',
    comfyuiWorkflowDefault: '기본',
    comfyuiWorkflowSetDefault: '기본으로 설정',
    comfyuiWorkflowInvalid: '유효하지 않은 워크플로우',
  },
  gallery: {
    title: '갤러리',
    imageCount: '{{count}}개 이미지',
  ...
  scene: {
    ...
    duplicateScene: '씬 복제',
    sceneDuplicated: '씬이 복제되었습니다',
    duplicateSceneFailed: '씬 복제에 실패했습니다',
    sceneThumb: '씬 썸네일',
    projectThumb: '프로젝트 썸네일',
    ...
    noSearchResults: '"{{query}}"에 해당하는 씬이 없습니다',
    sortDefault: '기본 순서',
    sortNameAsc: '이름 오름차순',
    sortNameDesc: '이름 내림차순',
    sortImagesDesc: '이미지 많은 순',
    sortImagesAsc: '이미지 적은 순',
    sortCreatedAsc: '오래된 순',
    sortCreatedDesc: '최신 순',
    compare: '비교',
    compareImages: '{{count}}장',
    page: '{{current}} / {{total}}',
    selectMode: '선택',
    selectedCount: '{{count}}개 선택',
    selectAll: '전체 선택',
    ...
    templateName: '템플릿 이름',
    convertSuccess: '템플릿이 생성되었습니다',
    convertFailed: '템플릿 생성에 실패했습니다',
  },
  templates: {
    title: '씬 템플릿',
  ...
  quickGenerate: {
    ...
    dropToImport: 'NAI 이미지를 드롭하여 설정 가져오기',
    importFromImage: '이미지에서 가져오기',
    importFields: '가져올 항목 선택',
    generalPrompt: '일반 프롬프트',
    negativePrompt2: '네거티브 프롬프트',
    characterPrompts: '캐릭터 프롬프트 ({{count}}개)',
    generationParameters: '생성 파라미터',
    resolution: '해상도',
    noMetadata: '이 이미지에서 NAI 메타데이터를 찾을 수 없습니다',
    importApply: '적용',
    imported: '이미지에서 설정을 가져왔습니다',
  },
  history: {
    title: '히스토리',
  ...
  params: {
    ...
    seed: '시드',
    seedHelp: '재현 가능한 생성을 위한 고정 시드. 끄면 랜덤.',
    seedFixed: '시드 고정',
    seedRandom: '랜덤',
    width: '너비',
    height: '높이',
  ...
  bundles: {
    ...
    bundleName: '번들 이름',
    bundleContent: '내용',
    bundleCreated: '번들이 생성되었습니다',
    createFailed: '번들 생성에 실패했습니다',
    bundleUpdated: '번들이 저장되었습니다',
    updateFailed: '번들 저장에 실패했습니다',
    ...
    thumbnailFailed: '썸네일 설정에 실패했습니다',
    searchBundles: '번들 검색...',
    selectBundle: '편집할 번들을 선택하세요',
  ...
  reference: {
    ...
    addImage: '이미지 추가',
    dropOrClick: '이미지를 드롭하거나 클릭하여 업로드',
    strength: '강도',
    informationExtracted: '정보 추출',
    fidelity: '충실도',
    mode: '모드',
    modeCharacter: '캐릭터',
    modeStyle: '스타일',
    modeCharacterStyle: '캐릭터 & 스타일',
    v45Only: 'V4.5 모델 전용',
    enabled: '활성',
    disabled: '비활성',
    encodingPending: '다음 생성 시 인코딩됨',
    encodingMismatch: '재인코딩 필요 (모델 변경)',
    deleteConfirm: '이 참조 이미지를 삭제하시겠습니까?',
    deleteDesc: '참조 이미지가 영구적으로 삭제됩니다.',
    uploadFailed: '참조 이미지 업로드 실패',
    deleteFailed: '참조 이미지 삭제 실패',
    ...
    comfyuiNote:
      '참조 이미지는 ComfyUI 워크플로우에서 관리됩니다 (IPAdapter, ControlNet 등)',
  },
  comfyuiParams: {
    workflow: '워크플로우',
    workflowHelp: '생성에 사용할 ComfyUI 워크플로우 템플릿',
    model: '체크포인트',
    modelHelp: 'Stable Diffusion 체크포인트 모델',
    noWorkflows: '설정에서 워크플로우를 먼저 업로드하세요',
    loadingModels: '모델 로딩 중...',
    noModels: 'ComfyUI 서버에 먼저 연결하세요',
  },
}
